...
namespace DeliveryServiceTests.Controllers
{
    ...
    public class AccountControllerTest
    {
        ...
        public void TestMethod1()
        {
            ...
            //Assert
           // Assert.E("PinkWarrior", user.Result.UserName);

            Assert.Null(userManager.FindByNameAsync("mewo"));

           //AccountController accountController = new AccountController(userManager, createSignInManager, createMockEmailSender().Object, createMockLogger().Object);
        }
    }
}
