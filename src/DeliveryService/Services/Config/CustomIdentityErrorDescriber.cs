...
namespace DeliveryService.Services.Config
{
    ...
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"User with the given email '{userName}' address already exists." }; }
