...
namespace DeliveryService.Services
{
    ...
    public class AuthMessageSenderForProductionEnvironment : IEmailSender, ISmsSender
    {
        public AuthMessageSenderForProductionEnvironment(IOptions<AuthMessageSenderOptions> optionsAccessor)
        {
