...
{
    /*
* Controller responsible for actions related to account management - eg password change.
* A user needs to be authenticated in order to access this controller methods 
* 
*/
    [Authorize]
